        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstablishmentName = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transaction_Person_IdPerson",
                        column: x => x.IdPerson,
                        principalTable: "Person",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transaction_TransactionType_IdTransactionType",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Query_IdPerson",
                table: "Query",
                column: "IdPerson");

            migrationBuilder.CreateIndex(
                name: "IX_Score_IdPerson",
                table: "Score",
                column: "IdPerson",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Transaction_IdPerson",
                table: "Transaction",
                column: "IdPerson");
